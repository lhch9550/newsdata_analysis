...
- 기존 KPF-BERT 모델과 토크나이저는 [빅카이즈 허깅페이스](https://huggingface.co/KPF/KPF-bert-cls2)에서 다운로드
- 학습 데이터는 [모두의 말뭉치 데이터](https://kli.korean.go.kr/corpus/main/requestMain.do)를 활용하였음
